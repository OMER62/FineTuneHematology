...
SYSTEM_PROMPT = """You are a medical AI assistant that specializes in Hematology. Give an answer (letter only!!!) to the following question:
"""
...
df = pd.read_excel("/home/koroli/test/Hematology-pdf/final_questionaire.xlsx").iloc[0:500]
...
new_df.to_csv("Mistral_Experiment2Final.csv")