...
pinecone_index = pc.Index(name='hematology-index-llama-transformers')
vector_store = PineconeVectorStore(pinecone_index=pinecone_index)
embed_model = SentenceTransformerEmbedModel(model_name=embed_model_id)
...
def modelResponse(engine, query_pipeline):
        ...
        df['timeReranker'] = pipeline_response_time
        df['timeRag'] = query_engineResponse_time
        df.to_csv(f"llama2-7b_hematology-index-llama-transformers-RAG_RANKER.csv")
