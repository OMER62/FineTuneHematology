...
pinecone_index_name = "hematology-index-full"
...
def modelResponse(engine, query_pipeline, llm):
        ...
        df = pd.read_excel("Harrisons_Hematology_and_Oncology_2ed_questionsPage743.xlsx")
        ...
        for q_id, question in enumerate(questions):
            ...
            print(f"queryEngineAnswer ({q_id})")
        ...
        df.to_csv(f"llama2-7b_hematology-index-full_HarrisonQA.csv", escapechar="\\")
